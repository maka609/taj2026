...
export default async function NewsDetailPage({ params }: NewsDetailPageProps) {
  ...
  const content = locale === 'ar' ? news.contentAr : news.contentEn;
    ...
    <div className="min-h-screen bg-gray-50 py-12" dir={locale === 'ar' ? 'rtl' : 'ltr'}>
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <article className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          {/* Image */}
          {news.imageUrl && (
            <div className="w-full h-96 bg-gradient-to-br from-primary/10 to-primary/5">
              <img
                src={news.imageUrl}
                alt={title}
          ...
          <div className="p-8 lg:p-12">
            ...
            <div className="mt-12 pt-8 border-t border-gray-200">
              <p className="text-sm font-semibold text-gray-700 mb-4">
                {locale === 'ar' ? 'شارك هذا الخبر:' : 'Share this news:'}
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
              <p className="text-gray-500 text-center py-8">
                {locale === 'ar' ? 'لا توجد أخبار ذات صلة' : 'No related news'}
              </p>
            </div>
          </div>
        </div>
